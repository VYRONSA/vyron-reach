...
import { aIWebsiteOptimizationCore } from '@/lib/aIWebsiteOptimizationCore'

export function AIWebsiteOptimizationCorePage(){
 const items = aIWebsiteOptimizationCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[58px] border border-emerald-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Website Optimization Core
    </h1>
