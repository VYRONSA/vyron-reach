...
import { autonomousCampaignArchitecture } from '@/lib/autonomousCampaignArchitecture'

export function AutonomousCampaignArchitecturePage(){
 const items = autonomousCampaignArchitecture()
