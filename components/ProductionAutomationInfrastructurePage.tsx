...
import { productionAutomationInfrastructure } from '@/lib/productionAutomationInfrastructure'

export function ProductionAutomationInfrastructurePage(){
 const items = productionAutomationInfrastructure()
