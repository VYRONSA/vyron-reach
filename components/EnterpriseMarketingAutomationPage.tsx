'use client'
import { enterpriseMarketingAutomation } from '@/lib/enterpriseMarketingAutomation'

export function EnterpriseMarketingAutomationPage(){
 const items = enterpriseMarketingAutomation()
