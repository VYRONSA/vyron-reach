...
import { autonomousVideoInfrastructure } from '@/lib/autonomousVideoInfrastructure'

export function AutonomousVideoInfrastructurePage(){
 const items = autonomousVideoInfrastructure()

 return (
  <div className="space-y-6">
   <div className="rounded-[48px] border border-emerald-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      Autonomous Video Infrastructure
    </h1>
