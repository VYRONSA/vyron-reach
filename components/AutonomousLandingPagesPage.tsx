'use client'
import { autonomousLandingPages } from '@/lib/autonomousLandingPages'

export function AutonomousLandingPagesPage(){
 const items = autonomousLandingPages()

 return (
  <div className="space-y-6">
   <div className="rounded-[36px] border border-orange-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Autonomous Landing Pages
    </h1>
