'use client'
import { autonomousGrowthIntelligence } from '@/lib/autonomousGrowthIntelligence'

export function AutonomousGrowthIntelligencePage(){
 const items = autonomousGrowthIntelligence()
