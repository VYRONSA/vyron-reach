...
import { aIVisualGrowthInfrastructure } from '@/lib/aIVisualGrowthInfrastructure'

export function AIVisualGrowthInfrastructurePage(){
 const items = aIVisualGrowthInfrastructure()

 return (
  <div className="space-y-6">
   <div className="rounded-[58px] border border-emerald-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Visual Growth Infrastructure
    </h1>
