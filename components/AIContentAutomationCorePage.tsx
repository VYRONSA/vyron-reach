...
import { aIContentAutomationCore } from '@/lib/aIContentAutomationCore'

export function AIContentAutomationCorePage(){
 const items = aIContentAutomationCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[62px] border border-violet-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Content Automation Core
    </h1>
