'use client'
import { aIVisualSalesFunnels } from '@/lib/aIVisualSalesFunnels'

export function AIVisualSalesFunnelsPage(){
 const items = aIVisualSalesFunnels()

 return (
  <div className="space-y-6">
   <div className="rounded-[36px] border border-emerald-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      AI Visual Sales Funnels
    </h1>
