'use client'
import { productionMarketingCore } from '@/lib/productionMarketingCore'

export function ProductionMarketingCorePage(){
 const items = productionMarketingCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[44px] border border-indigo-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Production Marketing Core
    </h1>
