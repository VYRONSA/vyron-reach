...
import { productionCreativeKernel } from '@/lib/productionCreativeKernel'

export function ProductionCreativeKernelPage(){
 const items = productionCreativeKernel()

 return (
  <div className="space-y-6">
   <div className="rounded-[52px] border border-indigo-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      Production Creative Kernel
    </h1>
