...
import { aIVisualInfrastructureCore } from '@/lib/aIVisualInfrastructureCore'

export function AIVisualInfrastructureCorePage(){
 const items = aIVisualInfrastructureCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[56px] border border-blue-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Visual Infrastructure Core
    </h1>
