...
import { enterpriseLeadInfrastructure } from '@/lib/enterpriseLeadInfrastructure'

export function EnterpriseLeadInfrastructurePage(){
 const items = enterpriseLeadInfrastructure()
