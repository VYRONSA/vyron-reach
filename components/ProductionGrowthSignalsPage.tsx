...
import { productionGrowthSignals } from '@/lib/productionGrowthSignals'

export function ProductionGrowthSignalsPage(){
 const items = productionGrowthSignals()

 return (
  <div className="space-y-6">
   <div className="rounded-[52px] border border-indigo-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      Production Growth Signals
    </h1>
