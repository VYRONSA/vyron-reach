...
import { productionCampaignExecution } from '@/lib/productionCampaignExecution'

export function ProductionCampaignExecutionPage(){
 const items = productionCampaignExecution()
