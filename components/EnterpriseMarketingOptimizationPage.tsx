...
import { enterpriseMarketingOptimization } from '@/lib/enterpriseMarketingOptimization'

export function EnterpriseMarketingOptimizationPage(){
 const items = enterpriseMarketingOptimization()
