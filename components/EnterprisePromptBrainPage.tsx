...
import { enterprisePromptBrain } from '@/lib/enterprisePromptBrain'

export function EnterprisePromptBrainPage(){
 const items = enterprisePromptBrain()

 return (
  <div className="space-y-6">
   <div className="rounded-[48px] border border-blue-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      Enterprise Prompt Brain
    </h1>
