'use client'
import { websiteIntelligenceScanner } from '@/lib/websiteIntelligenceScanner'

export function WebsiteIntelligenceScannerPage(){
 const items = websiteIntelligenceScanner()
