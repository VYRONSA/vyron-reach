...
import { productionGrowthInfrastructure } from '@/lib/productionGrowthInfrastructure'

export function ProductionGrowthInfrastructurePage(){
 const items = productionGrowthInfrastructure()
