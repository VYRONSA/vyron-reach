...
import { productionAIInfrastructure } from '@/lib/productionAIInfrastructure'

export function ProductionAIInfrastructurePage(){
 const items = productionAIInfrastructure()
