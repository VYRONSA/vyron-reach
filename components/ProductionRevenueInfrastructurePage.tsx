...
import { productionRevenueInfrastructure } from '@/lib/productionRevenueInfrastructure'

export function ProductionRevenueInfrastructurePage(){
 const items = productionRevenueInfrastructure()
