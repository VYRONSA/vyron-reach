...
import { autonomousCampaignOptimization } from '@/lib/autonomousCampaignOptimization'

export function AutonomousCampaignOptimizationPage(){
 const items = autonomousCampaignOptimization()
