'use client'
import { revenueAccelerationCore } from '@/lib/revenueAccelerationCore'

export function RevenueAccelerationCorePage(){
 const items = revenueAccelerationCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[38px] border border-pink-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Revenue Acceleration Core
    </h1>
