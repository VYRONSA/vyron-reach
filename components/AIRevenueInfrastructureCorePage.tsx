...
import { aIRevenueInfrastructureCore } from '@/lib/aIRevenueInfrastructureCore'

export function AIRevenueInfrastructureCorePage(){
 const items = aIRevenueInfrastructureCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[58px] border border-emerald-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Revenue Infrastructure Core
    </h1>
