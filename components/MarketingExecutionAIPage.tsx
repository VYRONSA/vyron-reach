'use client'
import { marketingExecutionAI } from '@/lib/marketingExecutionAI'

export function MarketingExecutionAIPage(){
 const items = marketingExecutionAI()

 return (
  <div className="space-y-6">
   <div className="rounded-[42px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Marketing Execution AI
    </h1>
