...
import { aIAdvertisingInfrastructure } from '@/lib/aIAdvertisingInfrastructure'

export function AIAdvertisingInfrastructurePage(){
 const items = aIAdvertisingInfrastructure()
