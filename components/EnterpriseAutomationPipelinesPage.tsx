'use client'
import { enterpriseAutomationPipelines } from '@/lib/enterpriseAutomationPipelines'

export function EnterpriseAutomationPipelinesPage(){
 const items = enterpriseAutomationPipelines()
