...
import { aILeadInfrastructureCore } from '@/lib/aILeadInfrastructureCore'

export function AILeadInfrastructureCorePage(){
 const items = aILeadInfrastructureCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[62px] border border-violet-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Lead Infrastructure Core
    </h1>
