'use client'
import { creativeScalingFunnels } from '@/lib/creativeScalingFunnels'

export function CreativeScalingFunnelsPage(){
 const items = creativeScalingFunnels()

 return (
  <div className="space-y-6">
   <div className="rounded-[42px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Creative Scaling Funnels
    </h1>
