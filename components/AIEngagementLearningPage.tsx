...
import { aIEngagementLearning } from '@/lib/aIEngagementLearning'

export function AIEngagementLearningPage(){
 const items = aIEngagementLearning()

 return (
  <div className="space-y-6">
   <div className="rounded-[52px] border border-indigo-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Engagement Learning
    </h1>
