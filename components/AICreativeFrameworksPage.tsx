'use client'
import { aICreativeFrameworks } from '@/lib/aICreativeFrameworks'

export function AICreativeFrameworksPage(){
 const items = aICreativeFrameworks()

 return (
  <div className="space-y-6">
   <div className="rounded-[40px] border border-blue-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      AI Creative Frameworks
    </h1>
