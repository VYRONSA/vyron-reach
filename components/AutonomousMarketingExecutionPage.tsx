...
import { autonomousMarketingExecution } from '@/lib/autonomousMarketingExecution'

export function AutonomousMarketingExecutionPage(){
 const items = autonomousMarketingExecution()
