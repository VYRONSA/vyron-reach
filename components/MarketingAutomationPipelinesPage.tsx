'use client'
import { marketingAutomationPipelines } from '@/lib/marketingAutomationPipelines'

export function MarketingAutomationPipelinesPage(){
 const items = marketingAutomationPipelines()
