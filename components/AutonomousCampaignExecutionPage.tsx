...
import { autonomousCampaignExecution } from '@/lib/autonomousCampaignExecution'

export function AutonomousCampaignExecutionPage(){
 const items = autonomousCampaignExecution()
