'use client'
import { campaignOptimizationMemory } from '@/lib/campaignOptimizationMemory'

export function CampaignOptimizationMemoryPage(){
 const items = campaignOptimizationMemory()

 return (
  <div className="space-y-6">
   <div className="rounded-[46px] border border-violet-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Campaign Optimization Memory
    </h1>
