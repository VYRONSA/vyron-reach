'use client'
import { autonomousCreativeInsights } from '@/lib/autonomousCreativeInsights'

export function AutonomousCreativeInsightsPage(){
 const items = autonomousCreativeInsights()

 return (
  <div className="space-y-6">
   <div className="rounded-[36px] border border-orange-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Autonomous Creative Insights
    </h1>
