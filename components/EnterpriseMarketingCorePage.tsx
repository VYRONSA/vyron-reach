'use client'
import { enterpriseMarketingCore } from '@/lib/enterpriseMarketingCore'

export function EnterpriseMarketingCorePage(){
 const items = enterpriseMarketingCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[40px] border border-blue-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Enterprise Marketing Core
    </h1>
