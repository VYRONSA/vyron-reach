'use client'
import { autonomousBrandGrowth } from '@/lib/autonomousBrandGrowth'

export function AutonomousBrandGrowthPage(){
 const items = autonomousBrandGrowth()

 return (
  <div className="space-y-4">
   <div className="rounded-[32px] border border-violet-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Autonomous Brand Growth
    </h1>
