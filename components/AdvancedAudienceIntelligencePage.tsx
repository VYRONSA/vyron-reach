'use client'
import { advancedAudienceIntelligence } from '@/lib/advancedAudienceIntelligence'

export function AdvancedAudienceIntelligencePage(){
 const items = advancedAudienceIntelligence()
