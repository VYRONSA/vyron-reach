'use client'
import { advancedCreativeGeneration } from '@/lib/advancedCreativeGeneration'

export function AdvancedCreativeGenerationPage(){
 const items = advancedCreativeGeneration()
