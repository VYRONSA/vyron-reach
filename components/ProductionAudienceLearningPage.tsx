...
import { productionAudienceLearning } from '@/lib/productionAudienceLearning'

export function ProductionAudienceLearningPage(){
 const items = productionAudienceLearning()
