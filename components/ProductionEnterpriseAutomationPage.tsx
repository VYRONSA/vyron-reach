...
import { productionEnterpriseAutomation } from '@/lib/productionEnterpriseAutomation'

export function ProductionEnterpriseAutomationPage(){
 const items = productionEnterpriseAutomation()
