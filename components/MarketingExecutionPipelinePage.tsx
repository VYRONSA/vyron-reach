'use client'
import { marketingExecutionPipeline } from '@/lib/marketingExecutionPipeline'

export function MarketingExecutionPipelinePage(){
 const items = marketingExecutionPipeline()
