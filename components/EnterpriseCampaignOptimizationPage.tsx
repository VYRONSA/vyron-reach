...
import { enterpriseCampaignOptimization } from '@/lib/enterpriseCampaignOptimization'

export function EnterpriseCampaignOptimizationPage(){
 const items = enterpriseCampaignOptimization()
