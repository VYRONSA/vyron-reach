'use client'
import { enterpriseCampaignMemory } from '@/lib/enterpriseCampaignMemory'

export function EnterpriseCampaignMemoryPage(){
 const items = enterpriseCampaignMemory()

 return (
  <div className="space-y-6">
   <div className="rounded-[48px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Enterprise Campaign Memory
    </h1>
