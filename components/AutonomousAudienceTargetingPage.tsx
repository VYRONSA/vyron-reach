'use client'
import { autonomousAudienceTargeting } from '@/lib/autonomousAudienceTargeting'

export function AutonomousAudienceTargetingPage(){
 const items = autonomousAudienceTargeting()
