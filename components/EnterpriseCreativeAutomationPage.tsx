...
import { enterpriseCreativeAutomation } from '@/lib/enterpriseCreativeAutomation'

export function EnterpriseCreativeAutomationPage(){
 const items = enterpriseCreativeAutomation()
