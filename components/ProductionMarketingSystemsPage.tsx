...
import { productionMarketingSystems } from '@/lib/productionMarketingSystems'

export function ProductionMarketingSystemsPage(){
 const items = productionMarketingSystems()
