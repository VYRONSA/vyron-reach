...
import { productionWebsiteInfrastructure } from '@/lib/productionWebsiteInfrastructure'

export function ProductionWebsiteInfrastructurePage(){
 const items = productionWebsiteInfrastructure()
