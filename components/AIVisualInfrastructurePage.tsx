...
import { aIVisualInfrastructure } from '@/lib/aIVisualInfrastructure'

export function AIVisualInfrastructurePage(){
 const items = aIVisualInfrastructure()

 return (
  <div className="space-y-6">
   <div className="rounded-[52px] border border-indigo-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Visual Infrastructure
    </h1>
