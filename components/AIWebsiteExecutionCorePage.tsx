...
import { aIWebsiteExecutionCore } from '@/lib/aIWebsiteExecutionCore'

export function AIWebsiteExecutionCorePage(){
 const items = aIWebsiteExecutionCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[56px] border border-blue-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Website Execution Core
    </h1>
