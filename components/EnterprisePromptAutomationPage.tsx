'use client'
import { enterprisePromptAutomation } from '@/lib/enterprisePromptAutomation'

export function EnterprisePromptAutomationPage(){
 const items = enterprisePromptAutomation()

 return (
  <div className="space-y-6">
   <div className="rounded-[46px] border border-violet-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Enterprise Prompt Automation
    </h1>
