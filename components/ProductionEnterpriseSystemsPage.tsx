...
import { productionEnterpriseSystems } from '@/lib/productionEnterpriseSystems'

export function ProductionEnterpriseSystemsPage(){
 const items = productionEnterpriseSystems()
