'use client'
import { autonomousMarketingDirector } from '@/lib/autonomousMarketingDirector'

export function AutonomousMarketingDirectorPage(){
 const items = autonomousMarketingDirector()
