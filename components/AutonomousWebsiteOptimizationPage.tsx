'use client'
import { autonomousWebsiteOptimization } from '@/lib/autonomousWebsiteOptimization'

export function AutonomousWebsiteOptimizationPage(){
 const items = autonomousWebsiteOptimization()
