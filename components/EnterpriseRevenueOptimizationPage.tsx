...
import { enterpriseRevenueOptimization } from '@/lib/enterpriseRevenueOptimization'

export function EnterpriseRevenueOptimizationPage(){
 const items = enterpriseRevenueOptimization()
