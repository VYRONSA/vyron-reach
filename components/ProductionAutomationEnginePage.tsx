...
import { productionAutomationEngine } from '@/lib/productionAutomationEngine'

export function ProductionAutomationEnginePage(){
 const items = productionAutomationEngine()
