...
import { productionVisualAutomation } from '@/lib/productionVisualAutomation'

export function ProductionVisualAutomationPage(){
 const items = productionVisualAutomation()
