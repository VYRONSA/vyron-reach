...
import { enterpriseGrowthOptimization } from '@/lib/enterpriseGrowthOptimization'

export function EnterpriseGrowthOptimizationPage(){
 const items = enterpriseGrowthOptimization()

 return (
  <div className="space-y-6">
   <div className="rounded-[64px] border border-blue-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      Enterprise Growth Optimization
    </h1>
