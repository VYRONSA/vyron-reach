...
import { autonomousRevenueInfrastructure } from '@/lib/autonomousRevenueInfrastructure'

export function AutonomousRevenueInfrastructurePage(){
 const items = autonomousRevenueInfrastructure()
