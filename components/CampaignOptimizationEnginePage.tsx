...
import { campaignOptimizationEngine } from '@/lib/campaignOptimizationEngine'

export function CampaignOptimizationEnginePage(){
 const items = campaignOptimizationEngine()
