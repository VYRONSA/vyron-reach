...
import { enterpriseVisualInfrastructure } from '@/lib/enterpriseVisualInfrastructure'

export function EnterpriseVisualInfrastructurePage(){
 const items = enterpriseVisualInfrastructure()
