...
import { enterpriseAIInfrastructure } from '@/lib/enterpriseAIInfrastructure'

export function EnterpriseAIInfrastructurePage(){
 const items = enterpriseAIInfrastructure()
