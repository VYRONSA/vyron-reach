'use client'
import { marketingAIExecution } from '@/lib/marketingAIExecution'

export function MarketingAIExecutionPage(){
 const items = marketingAIExecution()

 return (
  <div className="space-y-5">
   <div className="rounded-[34px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Marketing AI Execution
    </h1>
