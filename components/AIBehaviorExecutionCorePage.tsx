...
import { aIBehaviorExecutionCore } from '@/lib/aIBehaviorExecutionCore'

export function AIBehaviorExecutionCorePage(){
 const items = aIBehaviorExecutionCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[60px] border border-cyan-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Behavior Execution Core
    </h1>
