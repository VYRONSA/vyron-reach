'use client'
import { advancedCreativeAutomation } from '@/lib/advancedCreativeAutomation'

export function AdvancedCreativeAutomationPage(){
 const items = advancedCreativeAutomation()
