'use client'
import { brandPsychologyEngine } from '@/lib/brandPsychologyEngine'

export function BrandPsychologyEnginePage(){
 const items = brandPsychologyEngine()

 return (
  <div className="space-y-4">
   <div className="rounded-[32px] border border-violet-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Brand Psychology Engine
    </h1>
