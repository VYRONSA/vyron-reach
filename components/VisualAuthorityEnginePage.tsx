'use client'
import { visualAuthorityEngine } from '@/lib/visualAuthorityEngine'

export function VisualAuthorityEnginePage(){
 const items = visualAuthorityEngine()

 return (
  <div className="space-y-6">
   <div className="rounded-[38px] border border-pink-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Visual Authority Engine
    </h1>
