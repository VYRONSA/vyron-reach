'use client'
import { aIRevenueGrowthSignals } from '@/lib/aIRevenueGrowthSignals'

export function AIRevenueGrowthSignalsPage(){
 const items = aIRevenueGrowthSignals()

 return (
  <div className="space-y-6">
   <div className="rounded-[42px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      AI Revenue Growth Signals
    </h1>
