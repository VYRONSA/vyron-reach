...
import { enterpriseGrowthInfrastructure } from '@/lib/enterpriseGrowthInfrastructure'

export function EnterpriseGrowthInfrastructurePage(){
 const items = enterpriseGrowthInfrastructure()
