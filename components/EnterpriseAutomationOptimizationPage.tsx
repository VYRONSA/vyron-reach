...
import { enterpriseAutomationOptimization } from '@/lib/enterpriseAutomationOptimization'

export function EnterpriseAutomationOptimizationPage(){
 const items = enterpriseAutomationOptimization()
