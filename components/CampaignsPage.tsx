...
export function CampaignsPage({
  ...
  const rows = safeArray(campaigns || source.campaigns)
        ...
        <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-400">
              Marketing campaigns you manage internally. Clients only receive campaign reports and recommendations.
            </p>
          </div>
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((item: any, index: number) => (
            <button
              ...
              onClick={() => setDrill(createRecord(item, 'Campaigns'))}
