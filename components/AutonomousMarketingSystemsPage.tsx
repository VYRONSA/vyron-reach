...
import { autonomousMarketingSystems } from '@/lib/autonomousMarketingSystems'

export function AutonomousMarketingSystemsPage(){
 const items = autonomousMarketingSystems()
