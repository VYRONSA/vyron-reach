'use client'
import { conversionStoryEngine } from '@/lib/conversionStoryEngine'

export function ConversionStoryEnginePage(){
 const items = conversionStoryEngine()

 return (
  <div className="space-y-6">
   <div className="rounded-[36px] border border-orange-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Conversion Story Engine
    </h1>
