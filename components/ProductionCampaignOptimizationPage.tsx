...
import { productionCampaignOptimization } from '@/lib/productionCampaignOptimization'

export function ProductionCampaignOptimizationPage(){
 const items = productionCampaignOptimization()
