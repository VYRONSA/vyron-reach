...
import { aIProductionInfrastructure } from '@/lib/aIProductionInfrastructure'

export function AIProductionInfrastructurePage(){
 const items = aIProductionInfrastructure()
