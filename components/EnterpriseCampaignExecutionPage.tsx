...
import { enterpriseCampaignExecution } from '@/lib/enterpriseCampaignExecution'

export function EnterpriseCampaignExecutionPage(){
 const items = enterpriseCampaignExecution()

 return (
  <div className="space-y-6">
   <div className="rounded-[56px] border border-blue-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      Enterprise Campaign Execution
    </h1>
