'use client'
import { autonomousCreativeDirector } from '@/lib/autonomousCreativeDirector'

export function AutonomousCreativeDirectorPage(){
 const items = autonomousCreativeDirector()
