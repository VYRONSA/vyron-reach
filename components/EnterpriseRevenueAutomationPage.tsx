...
import { enterpriseRevenueAutomation } from '@/lib/enterpriseRevenueAutomation'

export function EnterpriseRevenueAutomationPage(){
 const items = enterpriseRevenueAutomation()
