...
import { productionExecutionInfrastructure } from '@/lib/productionExecutionInfrastructure'

export function ProductionExecutionInfrastructurePage(){
 const items = productionExecutionInfrastructure()
