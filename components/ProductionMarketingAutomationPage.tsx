...
import { productionMarketingAutomation } from '@/lib/productionMarketingAutomation'

export function ProductionMarketingAutomationPage(){
 const items = productionMarketingAutomation()
