...
import { autonomousGrowthInfrastructure } from '@/lib/autonomousGrowthInfrastructure'

export function AutonomousGrowthInfrastructurePage(){
 const items = autonomousGrowthInfrastructure()
