...
export default function Batch28_EnterpriseSecurityPage() {
  return (
    <ReachPageShell
      active="Enterprise Security"
      eyebrow="ENTERPRISE SECURITY CENTRE"
      title="Enterprise Security Centre"
      subtitle="Advanced enterprise protection, permissions, AI monitoring, login security, and operational governance."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="automation"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Enterprise Security Centre Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
