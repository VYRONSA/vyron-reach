...
export default function Batch19_ImageStudioPage() {
  return (
    <ReachPageShell
      active="AI Image Studio"
      eyebrow="AI IMAGE STUDIO"
      title="AI Image Studio"
      subtitle="Create banners, product shots, ad creatives, thumbnails, and branded marketing visuals with AI."
      liveLabel="LIVE IMAGE GENERATION ACTIVE"
      theme="websites"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="AI Image Studio Performance" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
