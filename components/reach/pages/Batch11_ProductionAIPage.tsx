...
export default function Batch11_ProductionAIPage() {
  return (
    <ReachPageShell
      active="Production AI"
      eyebrow="AI PRODUCTION COMMAND CENTRE"
      title="Production AI Command Centre"
      subtitle="Autonomous AI production pipelines for content, campaigns, videos, and enterprise-scale marketing execution."
      liveLabel="LIVE AI PRODUCTION ACTIVE"
      theme="automation"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Production AI Command Centre Performance" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
