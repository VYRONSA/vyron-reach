...
export default function Batch27_APICentrePage() {
  return (
    <ReachPageShell
      active="API Management"
      eyebrow="API MANAGEMENT CENTRE"
      title="API Management Centre"
      subtitle="Manage enterprise APIs, integrations, authentication keys, usage analytics, and platform connectivity."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="integrations"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="API Management Centre Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
