...
export default function Batch22_FunnelIntelligencePage() {
  return (
    <ReachPageShell
      active="Funnel Intelligence"
      eyebrow="FUNNEL INTELLIGENCE LAB"
      title="Funnel Intelligence Lab"
      subtitle="Visualize conversion flow, identify drop-offs, optimize user journeys, and maximize acquisition performance."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="revenue"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Funnel Intelligence Lab Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
