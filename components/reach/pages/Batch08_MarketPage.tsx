...
export default function Batch08_MarketPage() {
  return (
    <ReachPageShell active="Market Intelligence" eyebrow="MARKET INTELLIGENCE COMMAND CENTRE" title="Market Intelligence Command Centre" subtitle="Real-time market insights, competitor tracking, industry trends, and strategic opportunities to stay ahead of the competition." liveLabel="LIVE MARKET INTELLIGENCE ACTIVE" theme="market" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Market Intelligence Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
