...
export default function Batch31_ExecutiveCommandPage() {
  return (
    <ReachPageShell
      active="Executive Command"
      eyebrow="EXECUTIVE COMMAND CENTRE"
      title="Executive Command Centre"
      subtitle="Full enterprise visibility across the entire VYRON ecosystem with global AI operational oversight."
      liveLabel="GLOBAL ENTERPRISE SYSTEM ACTIVE"
      theme="revenue"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Executive Command Centre Intelligence" action="Enterprise View" className="xl:col-span-5">
          <LineChart />
        </Card>
