...
export default function Batch24_ClientWorkspacePage() {
  return (
    <ReachPageShell
      active="Client Workspace"
      eyebrow="CLIENT WORKSPACE"
      title="Client Workspace"
      subtitle="Enterprise-grade client collaboration portal with reporting, approvals, campaign reviews, and communication systems."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="websites"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Client Workspace Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
