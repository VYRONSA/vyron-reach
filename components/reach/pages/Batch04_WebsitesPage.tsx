...
export default function Batch04_WebsitesPage() {
  return (
    <ReachPageShell active="Websites" eyebrow="WEBSITE COMMAND CENTRE" title="Websites Command Centre" subtitle="Build, optimize, and scale high-converting websites with SEO intelligence, heatmaps, ranking movement, and conversion optimization." liveLabel="LIVE WEBSITE MONITORING ACTIVE" theme="websites" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Websites Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
