...
export default function Batch30_NotificationCentrePage() {
  return (
    <ReachPageShell
      active="Notification Centre"
      eyebrow="NOTIFICATION COMMAND CENTRE"
      title="Notification Command Centre"
      subtitle="Unified AI-powered alerts, campaign notifications, operational warnings, and enterprise event monitoring."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="audience"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Notification Command Centre Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
