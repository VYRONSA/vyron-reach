...
export default function Batch26_LogsActivityPage() {
  return (
    <ReachPageShell
      active="Logs & Activity"
      eyebrow="ACTIVITY & SYSTEM LOGS"
      title="Activity & System Logs"
      subtitle="Track enterprise activity, user actions, AI events, automation history, and execution visibility."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="market"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Activity & System Logs Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
