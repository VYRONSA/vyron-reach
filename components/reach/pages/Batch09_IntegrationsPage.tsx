...
export default function Batch09_IntegrationsPage() {
  return (
    <ReachPageShell active="Integrations" eyebrow="INTEGRATIONS CENTRE" title="Integrations Centre" subtitle="Connect your favourite tools and platforms. Unify your data, automate workflows, and scale without limits." liveLabel="24 ACTIVE CONNECTIONS" theme="integrations" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Integrations Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
