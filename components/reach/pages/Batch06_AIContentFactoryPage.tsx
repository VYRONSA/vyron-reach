...
export default function Batch06_AIContentFactoryPage() {
  return (
    <ReachPageShell active="AI Content Factory" eyebrow="AI CREATIVE PRODUCTION STUDIO" title="AI Content Factory" subtitle="Generate high-performing content, visuals, videos, copy, and campaigns in seconds with the power of AI." liveLabel="AI STUDIO ACTIVE" theme="content" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="AI Content Factory Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
