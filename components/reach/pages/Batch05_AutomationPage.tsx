...
export default function Batch05_AutomationPage() {
  return (
    <ReachPageShell active="Automation" eyebrow="AUTOMATION COMMAND CENTRE" title="Automation Command Centre" subtitle="Design, automate, and scale intelligent workflows. AI-powered execution that runs your entire marketing engine." liveLabel="LIVE AUTOMATION NETWORK ACTIVE" theme="automation" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Automation Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
