...
export default function Batch10_ReportsPage() {
  return (
    <ReachPageShell active="Reports" eyebrow="REPORTS CENTRE" title="Reports Centre" subtitle="Track performance, generate insights, and make data-driven decisions from one executive reporting surface." liveLabel="DATA LAST UPDATED: 5 MIN AGO" theme="reports" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Reports Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
