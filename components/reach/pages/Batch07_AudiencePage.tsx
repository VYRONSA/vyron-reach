...
export default function Batch07_AudiencePage() {
  return (
    <ReachPageShell active="Audience Intelligence" eyebrow="AUDIENCE INTELLIGENCE CENTRE" title="Audience Intelligence Centre" subtitle="Deep audience understanding, behavioral analysis, and predictive intelligence to help you reach the right people with the right message." liveLabel="LIVE AUDIENCE DATA ACTIVE" theme="audience" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Audience Intelligence Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
