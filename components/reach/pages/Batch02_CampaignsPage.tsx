...
export default function Batch02_CampaignsPage() {
  return (
    <ReachPageShell active="Campaigns" eyebrow="CAMPAIGN OPERATIONS CENTRE" title="Campaigns Command Centre" subtitle="Manage, optimize, and scale high-performing campaigns across every channel with live creative testing and audience intelligence." liveLabel="LIVE CAMPAIGN STREAM ACTIVE" theme="campaign" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Campaigns Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
