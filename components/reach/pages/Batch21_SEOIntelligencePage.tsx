...
export default function Batch21_SEOIntelligencePage() {
  return (
    <ReachPageShell
      active="SEO Intelligence"
      eyebrow="SEO INTELLIGENCE CENTRE"
      title="SEO Intelligence Centre"
      subtitle="Monitor rankings, search visibility, keyword intelligence, backlinks, and organic growth across all websites."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="market"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="SEO Intelligence Centre Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
