...
export default function Batch23_SocialMediaPage() {
  return (
    <ReachPageShell
      active="Social Media Command"
      eyebrow="SOCIAL MEDIA COMMAND CENTRE"
      title="Social Media Command Centre"
      subtitle="Manage social campaigns, engagement, audience growth, AI content scheduling, and influencer activity."
      liveLabel="LIVE ENTERPRISE SYSTEM ACTIVE"
      theme="campaign"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Social Media Command Centre Analytics" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
