...
export default function Batch01_DashboardPage() {
  return (
    <ReachPageShell active="Dashboard" eyebrow="AI REVENUE OPERATIONS COMMAND CENTRE" title="Revenue Command Centre" subtitle="AI-powered market expansion, outreach intelligence, and revenue operations — executive command visibility across your entire growth engine." liveLabel="LIVE INTELLIGENCE STREAM ACTIVE" theme="finance" kpis={kpis}>
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Dashboard Performance Overview" action="Last 30 Days" className="xl:col-span-5"><LineChart /></Card>
