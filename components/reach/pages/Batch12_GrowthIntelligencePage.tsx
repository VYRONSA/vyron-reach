...
export default function Batch12_GrowthIntelligencePage() {
  return (
    <ReachPageShell
      active="Growth Intelligence"
      eyebrow="GROWTH INTELLIGENCE CENTRE"
      title="Growth Intelligence Centre"
      subtitle="Forecast growth opportunities, identify expansion patterns, and monitor scaling performance across your business ecosystem."
      liveLabel="LIVE GROWTH ANALYTICS ACTIVE"
      theme="market"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Growth Intelligence Centre Performance" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
