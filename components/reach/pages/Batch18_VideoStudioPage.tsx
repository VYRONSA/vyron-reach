...
export default function Batch18_VideoStudioPage() {
  return (
    <ReachPageShell
      active="AI Video Studio"
      eyebrow="AI VIDEO STUDIO"
      title="AI Video Studio"
      subtitle="Generate AI-powered marketing videos, reels, ads, explainers, and social campaigns automatically."
      liveLabel="LIVE VIDEO GENERATION ACTIVE"
      theme="content"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="AI Video Studio Performance" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
