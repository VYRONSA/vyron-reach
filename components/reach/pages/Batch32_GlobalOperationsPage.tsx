...
export default function Batch32_GlobalOperationsPage() {
  return (
    <ReachPageShell
      active="Global Operations"
      eyebrow="GLOBAL OPERATIONS CENTRE"
      title="Global Operations Centre"
      subtitle="Monitor worldwide campaigns, performance regions, operational health, and enterprise execution globally."
      liveLabel="GLOBAL ENTERPRISE SYSTEM ACTIVE"
      theme="market"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Global Operations Centre Intelligence" action="Enterprise View" className="xl:col-span-5">
          <LineChart />
        </Card>
