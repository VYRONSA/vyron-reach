...
export default function Batch14_CompetitorTrackingPage() {
  return (
    <ReachPageShell
      active="Competitor Tracking"
      eyebrow="COMPETITOR TRACKING CENTRE"
      title="Competitor Tracking Centre"
      subtitle="Monitor competitors, pricing, campaigns, SEO rankings, and strategic market movement in real time."
      liveLabel="LIVE COMPETITOR MONITORING ACTIVE"
      theme="market"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="Competitor Tracking Centre Performance" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
