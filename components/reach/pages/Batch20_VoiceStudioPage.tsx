...
export default function Batch20_VoiceStudioPage() {
  return (
    <ReachPageShell
      active="Voice Studio"
      eyebrow="AI VOICE STUDIO"
      title="AI Voice Studio"
      subtitle="Generate AI voiceovers, narrations, podcasts, ad scripts, and multilingual audio content instantly."
      liveLabel="LIVE VOICE GENERATION ACTIVE"
      theme="content"
      kpis={kpis}
    >
      <div className="grid gap-4 xl:grid-cols-12">
        <Card title="AI Voice Studio Performance" action="Last 30 Days" className="xl:col-span-5">
          <LineChart />
        </Card>
