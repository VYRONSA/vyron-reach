...
import { enterpriseMarketingInfrastructure } from '@/lib/enterpriseMarketingInfrastructure'

export function EnterpriseMarketingInfrastructurePage(){
 const items = enterpriseMarketingInfrastructure()
