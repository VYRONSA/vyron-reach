...
import { autonomousBrandIntelligence } from '@/lib/autonomousBrandIntelligence'

export function AutonomousBrandIntelligencePage(){
 const items = autonomousBrandIntelligence()
