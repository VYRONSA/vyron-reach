...
import { enterpriseMarketingExecution } from '@/lib/enterpriseMarketingExecution'

export function EnterpriseMarketingExecutionPage(){
 const items = enterpriseMarketingExecution()
