...
import { autonomousEnterpriseInfrastructure } from '@/lib/autonomousEnterpriseInfrastructure'

export function AutonomousEnterpriseInfrastructurePage(){
 const items = autonomousEnterpriseInfrastructure()
