'use client'
import { autonomousVideoHooks } from '@/lib/autonomousVideoHooks'

export function AutonomousVideoHooksPage(){
 const items = autonomousVideoHooks()

 return (
  <div className="space-y-5">
   <div className="rounded-[34px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Autonomous Video Hooks
    </h1>
