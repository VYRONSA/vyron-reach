...
import { aIContentOptimizationCore } from '@/lib/aIContentOptimizationCore'

export function AIContentOptimizationCorePage(){
 const items = aIContentOptimizationCore()

 return (
  <div className="space-y-6">
   <div className="rounded-[56px] border border-blue-500/20 bg-[#0b0b1d] p-8">
    <h1 className="text-5xl font-black text-white">
      AI Content Optimization Core
    </h1>
