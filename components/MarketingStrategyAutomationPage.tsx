'use client'
import { marketingStrategyAutomation } from '@/lib/marketingStrategyAutomation'

export function MarketingStrategyAutomationPage(){
 const items = marketingStrategyAutomation()
