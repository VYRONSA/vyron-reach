...
import { enterpriseExecutionCommand } from '@/lib/enterpriseExecutionCommand'

export function EnterpriseExecutionCommandPage(){
 const items = enterpriseExecutionCommand()
