'use client'
import { creativeExecutionPipelines } from '@/lib/creativeExecutionPipelines'

export function CreativeExecutionPipelinesPage(){
 const items = creativeExecutionPipelines()
