...
import { autonomousMarketingInfrastructure } from '@/lib/autonomousMarketingInfrastructure'

export function AutonomousMarketingInfrastructurePage(){
 const items = autonomousMarketingInfrastructure()
