...
import { productionIntelligenceCore } from '@/lib/productionIntelligenceCore'

export function ProductionIntelligenceCorePage(){
 const items = productionIntelligenceCore()
