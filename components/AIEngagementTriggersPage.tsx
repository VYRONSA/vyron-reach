'use client'
import { aIEngagementTriggers } from '@/lib/aIEngagementTriggers'

export function AIEngagementTriggersPage(){
 const items = aIEngagementTriggers()

 return (
  <div className="space-y-6">
   <div className="rounded-[36px] border border-emerald-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      AI Engagement Triggers
    </h1>
