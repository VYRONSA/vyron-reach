'use client'
import { autonomousSEOScaling } from '@/lib/autonomousSEOScaling'

export function AutonomousSEOScalingPage(){
 const items = autonomousSEOScaling()

 return (
  <div className="space-y-6">
   <div className="rounded-[48px] border border-cyan-500/20 bg-[#0b0b1d] p-8 shadow-2xl">
    <h1 className="text-5xl font-black tracking-tight text-white">
      Autonomous SEO Scaling
    </h1>
